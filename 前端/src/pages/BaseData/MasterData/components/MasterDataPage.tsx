...
const MasterDataPage: React.FC<MasterDataPageProps> = ({ dimType, title, icon }) => {
      ...
      <Card>
        <div style={{ marginBottom: 16, display: 'flex', justifyContent: 'space-between' }}>
          ...
          <Space>
            ...
            <Button onClick={() => setExpandedRowKeys(data.map((d: any) => String(d.id)))}>全部展开</Button>
